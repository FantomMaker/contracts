...
// File contracts/ISalesFactory.sol
...
contract AllocationStaking is OwnableUpgradeable {
    ...
    // Total FAME redistributed between people staking
    uint256 public totalFameRedistributed;
    ...
    function redistributeFame(uint256 _pid, address _user, uint256 _amountToRedistribute) external
    onlyVerifiedSales
    {
    ...
    function burnFromUser(address user, uint256 _pid, uint256 amount) internal {
        ...
        totalFameRedistributed = totalFameRedistributed.add(amount);
